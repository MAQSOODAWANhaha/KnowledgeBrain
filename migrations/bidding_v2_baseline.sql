...
CREATE TABLE bid_docx_composition_request_identities (
  ...
  CHECK (jsonb_typeof(contract_definition) IS NOT DISTINCT FROM 'object'
    ...
    AND contract_definition->'checkpoint_contract_version' IS NOT DISTINCT FROM '8'::jsonb
...
BEGIN
  ...
  END IF;
  IF runtime->'checkpoint_contract_version' IS DISTINCT FROM '8'::jsonb
...
BEGIN
  IF jsonb_typeof(p_snapshot) IS DISTINCT FROM 'object'
    ...
    OR p_contract->'checkpoint_contract_version' IS DISTINCT FROM '8'::jsonb
