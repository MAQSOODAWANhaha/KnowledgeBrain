...
[产品](../PRODUCT.md)、[外壳视觉](../DESIGN.md)、[业务 PRD](../docs/bidding/prd.md)、[领域边界](../docs/bidding/authoring.md)、[编辑/保存契约](../docs/bidding/onlyoffice.md)。编辑与出件顺序见 [ONLYOFFICE 计划](../plans/bidding/onlyoffice-integration.md)，Agent 生成改造见 [投标生成统一方案](../plans/bidding/product-two-phase.md)；实现状态由主方案任务表维护。用户在解析完成后点击生成大纲，不因解析就绪自动启动任务。文件 / 编制 / 导出三步入口不变。
