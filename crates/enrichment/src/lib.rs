...
use domain::{Chunk, Store, SummaryStatus};
use index::index_one;
use uuid::Uuid;
...
mod tests {
    use super::*;
    use domain::{Chunk, Document, ProductVersion, Store, SummaryStatus};
    ...
    fn describe_image_without_vlm_is_error() {
        ...
        doc.parse_status = domain::ParseStatus::Processing;
        let did = doc.id;
    ...
    fn superseded_summary_does_not_finalize() {
        ...
        doc.attempt = 2;
        doc.parse_status = domain::ParseStatus::Finalizing;
