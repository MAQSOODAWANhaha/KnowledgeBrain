...
use crate::chunker::splitter::{Span, protected_spans, protected_spans_rune, split_text};
...
pub fn split_by_heuristics(
    text: &str,
    cfg: &SplitterConfig,
    _profile: Option<&crate::chunker::profiler::DocProfile>,
) -> Vec<TextChunk> {
    if text.is_empty() {
        return Vec::new();
    }
...
mod tests {
    use super::*;
    use crate::chunker::tokens::LANG_CHINESE;
