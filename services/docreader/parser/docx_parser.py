...
class Docx:
    ...
    def _identify_page_paragraph_mapping(self, max_page=100000):
        ...
        total_paragraphs = len(self._require_doc().paragraphs)
        ...
        page_breaks_found = 0
        for p_idx, p in enumerate(self._require_doc().paragraphs):
    ...
    def __call__(
        ...
        return list(self.all_lines), tbls
    ...
    def _check_document_has_images(self):
        ...
        if hasattr(doc, "inline_shapes") and len(doc.inline_shapes) > 0:
            ...
            logger.info(
                f"Document contains {len(doc.inline_shapes)} inline images"
            )
                ...
                for image_data in image_paths:
                    if (
                        ...
                        try:
                            ...
                            if not image_data.url and self.upload_file is not None:
