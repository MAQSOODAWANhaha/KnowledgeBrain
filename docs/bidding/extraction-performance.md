...
当前实施仅遵循[统一方案](../../plans/bidding/agent-runtime-rig.md)：S0–S6 阶段见 §15，调用、容量与成本要求见 §14，实际能力和未通过项见 §19。以下 v5/v6 等请求计时、窗口与故障结论保留为历史证据，不代表新版全部能力已实现，也不证明供应商故障已消除。
